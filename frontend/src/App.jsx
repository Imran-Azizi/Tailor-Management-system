...
import { ProtectedRoute, RoleRoute, WorkerProtectedRoute } from "./components/ProtectedRoute.jsx";
        ...
        <BrowserRouter>
          <Routes>
            ...
            >
              ...
              <Route path="orders/completed" element={<AllOrders filter="completed" />} />
              <Route path="orders/pending" element={<AllOrders filter="pending" />} />
              ...
              <Route path="customers/transactions" element={
                <RoleRoute roles={['ADMIN', 'DOKAN']}>
              ...
              <Route path="print-bills" element={
                <RoleRoute roles={['ADMIN', 'DOKAN']}>
                  <PrintBills />
                </RoleRoute>
              } />
