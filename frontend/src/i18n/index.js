  ...
  dari: {
    ...
    permissions: {
      ...
      labels: {
        ...
        "support.view": "تیم پشتیبانی",
        "orders.all.view": "دیدن همه سفارش‌ها",
        "orders.pending.view": "دیدن سفارش‌های در انتظار",
        "orders.completed.view": "دیدن سفارش‌های تکمیل‌شده",
        "orders.completedWorkers.view": "دیدن تکمیل‌شده‌ها از کارگرها",
        "orders.damaged.view": "دیدن لباس‌های خراب",
        "finance.workerReceipts.view": "دیدن رسید پرداخت کارگران",
        "finance.makeTransaction.view": "ثبت قرض",
        "finance.loans.view": "دیدن همه قرض‌ها",
        "rakht.list.view": "دیدن همه رخت‌ها",
        "rakht.payments.view": "دیدن تاریخچه پرداخت رخت",
        "inventory.itemSales.view": "دیدن ریکارد فروش اجناس",
        "settings.tenant.view": "دیدن تنظیمات سیستم",
        "settings.designs.view": "دیدن تنظیمات ظاهری",
        "settings.notifications.view": "دیدن اعلان‌ها",
      },
    },
  },
  pashto: {
    ...
    permissions: {
      ...
      labels: {
        ...
        "support.view": "د ملاتړ ټیم",
        "orders.all.view": "ټول فرمایشونه لیدل",
        "orders.pending.view": "په تمه فرمایشونه لیدل",
        "orders.completed.view": "بشپړ شوي فرمایشونه لیدل",
        "orders.completedWorkers.view": "د کارګرو بشپړ شوي لیدل",
        "orders.damaged.view": "خراب کالي لیدل",
        "finance.workerReceipts.view": "د کارګرو د پیسو رسید لیدل",
        "finance.makeTransaction.view": "پور ثبتول",
        "finance.loans.view": "ټول پورونه لیدل",
        "rakht.list.view": "ټول رختونه لیدل",
        "rakht.payments.view": "د رخت د تادیاتو تاریخچه لیدل",
        "inventory.itemSales.view": "د اجناسو د پلور ریکارډ لیدل",
        "settings.tenant.view": "د سیسټم تنظیمات لیدل",
        "settings.designs.view": "د بڼې تنظیمات لیدل",
        "settings.notifications.view": "خبرتیاوې لیدل",
      },
    },
  },
};
